...
Community listing assets live in `assets/` and are generated by `python3 assets/render.py`; the
aesthetic behind them is written down in [`assets/philosophy.md`](assets/philosophy.md). The
publishing checklist and the listing copy are in [`docs/PUBLISHING.md`](docs/PUBLISHING.md).
